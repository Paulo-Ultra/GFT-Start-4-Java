...
public class ExemploHashMap {
    public static void main(String[] args) {
        ...
        //entrySet() --> Retorna a coleção de chaves/valores contudo é necessário os métodos getKey() e getValue() para buscar
        ...
        //keySet() --> Vai retornar a coleção de valores que contém no Map
